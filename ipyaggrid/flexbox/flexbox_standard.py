...
d_flex_direction = {
    'name': 'flex-direction',
    'type': 'category',
    'li_possible': ['row', 'row-reverse', 'column', 'column-reverse'],
    'default': 'row',
...
d_flex_wrap = {
    'name': 'flex-wrap',
    'type': 'category',
    'li_possible': ['nowrap', 'wrap', 'wrap-reverse'],
    'default': 'wrap',
...
d_align_items = {
    'name': 'align-items',
    'type': 'category',
    'li_possible': ['flex-start', 'flex-end', 'center', 'baseline', 'stretch'],
    'default': 'flex-start',
...
d_order = {'name': 'order', 'type': 'int', 'default': 0, 'help': 'order: <integer>'}
...
d_align_self = {
    'name': 'align-self',
    'type': 'category',
    'li_possible': ['auto', 'flex-start', 'flex-end', 'center', 'baseline', 'stretch'],
    'default': 'auto',
...
d_width = {'name': 'width', 'type': 'length', 'default': None, 'allow_none': True}

d_height = {'name': 'height', 'type': 'length', 'default': None, 'allow_none': True}

d_margin = {'name': 'margin', 'type': 'length', 'default': None, 'allow_none': True}
